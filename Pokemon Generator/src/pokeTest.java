...
public class pokeTest {
	...
	public static void main(String[] args) {
		PokeData testPokemon = new PokeData("Bulbasaur", "A thing", new IVSet(31, 31, 31, 31, 31, 31), new EVSet(252, 252, 6, 0, 0, 0), "things and stuff", true, "beautiful", new MoveSet("Fly", "Splash", "Hydro Pump", "Ice Beam"));
