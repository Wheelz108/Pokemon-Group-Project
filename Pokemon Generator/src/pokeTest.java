...
public class pokeTest {
	public static void main(String[] args) {
		...
		try {
			PokeData testPokemon = new PokeData(species, item, new IVSet(IVHP, IVatk, IVdef, IVspAtk, IVspDef, IVspd), new EVSet(EVHP, EVatk, EVdef, EVspAtk, EVspDef, EVspd), ability, shiny, nature, new MoveSet(move1, move2, move3, move4));
